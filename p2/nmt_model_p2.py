...
class NMT(nn.Module):
    ...
    def step(self, Ybar_t: torch.Tensor,
        ...
        if enc_hiddens_proj.sum(): # if this is not empty
            ...
            e_t = self.V(F.tanh((enc_hiddens_proj + dec_hiddens_proj))).squeeze(2)


        else:
            ## dot product attention
            e_t = torch.bmm(dec_hidden.unsqueeze(1), enc_hiddens.permute(0,2,1)).squeeze(1)
